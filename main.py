...
# 1. SERVEUR WEB (Pour garder Replit éveillé)
app = Flask("")
...
def run_flask():
    # Use the workflow port locally; deployments may still provide PORT.
...
FOOTBALL_KEY = os.environ.get("FOOTBALL_API_KEY", "").strip()
...
def signal_crypto(msg):
    ...
    try:
        ...
        bot.reply_to(
            msg, "❌ Erreur lors de la récupération des données Binance."
        )
